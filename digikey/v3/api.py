...
import digikey.v3.partinformation
from digikey.v3.partinformation.rest import ApiException
from pprint import pprint

logger = logging.getLogger(__name__)

class DigiKeyWrapper(object):
    def __init__(self, wrapped_func, module):
        self.sandbox = False

        apinames = {
            digikey.v3.partinformation: 'Search'
        }

        apiclasses = {
            digikey.v3.partinformation: digikey.v3.partinformation.PartSearchApi
        }
        
        apiname = apinames[module]
        apiclasses = apiclasses[module]
